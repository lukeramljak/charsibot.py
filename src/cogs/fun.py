...
class Fun(commands.Cog):
    ...
    @commands.slash_command(description='Ask the magic 8-ball a question', guild_ids=[guild_id])
    ...
    @discord.slash_command(description='Brain not working?', guild_ids=[guild_id])
    ...
    @discord.slash_command(description='Tuck someone into bed', guild_ids=[guild_id])
    ...
    @discord.slash_command(description='Get a random dad joke', guild_ids=[guild_id])
    ...
    @discord.slash_command(description='Hug another user', guild_ids=[guild_id])
    async def hug(self, ctx, name: discord.Member):
        await ctx.respond(f'_hugs {name.mention}_')
        
    @discord.slash_command(description='Having a bad day? Get a random positive quote', guild_ids=[guild_id])
    ...
    @discord.slash_command(description='Give someone a nice big smooch', guild_ids=[guild_id])
    ...
    @discord.slash_command(description='Toss a tomato!', guild_ids=[guild_id])
